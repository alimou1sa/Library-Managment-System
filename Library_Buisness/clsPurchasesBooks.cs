...
this.MembersInfo = clsMembers.FindByID(MemberID);
    ...
    private bool _AddNewPurchasesBooks()
{ 
    this.PurchaseID = clsPurchasesBooksDataAccess.AddNewPurchasesBooks(this.BookID,this.MemberID,this.CopiesPurchased,this.TotalPrice,this.PurchaseDate,this.CreateByUserID);

    return (this.PurchaseID != -1); 
            
}private bool _UpdatePurchasesBooks()
{
    return clsPurchasesBooksDataAccess.UpdatePurchasesBooks(this.PurchaseID,this.BookID,this.MemberID,this.CopiesPurchased,this.TotalPrice,this.PurchaseDate,this.CreateByUserID);
}
...
{
    return clsPurchasesBooksDataAccess.DeletePurchasesBooks(PurchaseID);

}
public static DataTable GetListPurchasesBooks()
{

    return clsPurchasesBooksDataAccess.GetListPurchasesBooks();
}

public static bool IsPurchasesBooksExisteByID( int PurchaseID )
{
    return clsPurchasesBooksDataAccess.IsPurchasesBooksExisteByID(PurchaseID);
